...
Point Cylinder::rayIntersect(Point rayOrigin, Point rayDirection)
{
    ...
    Point center_to_origin = rayOrigin - this->center_base;

    Point v = center_to_origin -  (this->axis* center_to_origin.dot(this->axis));
    Point w = rayDirection.normalized() - (this->axis * rayDirection.normalized().dot(this->axis));
...
Point Cylinder::rayIntersect(Point rayOrigin, Point rayDirection)
{
    ...
    Point w = rayDirectionN - (this->axis * rayDirectionN.dot(this->axis));
